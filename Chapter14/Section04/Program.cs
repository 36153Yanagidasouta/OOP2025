    ...
    internal class Program {
        static async Task Main(string[] args) {
            ...
            hc.DefaultRequestHeaders.UserAgent.ParseAdd
                ("MyWikipediaClient/1.0 (Contact: contact@example.com)");
            var text = await GetFromWikipediaAsync(hc, "空色");
            Console.WriteLine( text );
        }

        static async Task GetHtmlExample(HttpClient httpClient) {
            var url = "https://weather.yahoo.co.jp/weather/jp/10/4210/10205.html";
